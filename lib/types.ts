...
export interface CompleteKycData {
  ...
  subscription: SubscriptionAgreementData;
...
// Subscription Agreement Data
export interface SubscriptionAgreementData {
  // Qualifications
  eligibleInvestorConfirmation: boolean;
  nonUsPersonConfirmation: boolean;
  
  // Subscription Details
  shareClassSelection: ShareClass;
  subscriptionAmount: number;
  subscriptionAmountWords?: string; // Auto-generated
  ...
  // Signatures
  signatoryCapacity?: string; // For entities
}

export type ShareClass = 'A1' | 'A2' | 'B1' | 'B2' | 'C' | 'N';

export const shareClassLabels: Record<ShareClass, string> = {
  A1: 'Class A1 Shares',
  A2: 'Class A2 Shares',
  B1: 'Class B1 Shares',
  B2: 'Class B2 Shares',
